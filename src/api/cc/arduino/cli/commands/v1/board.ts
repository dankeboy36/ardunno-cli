...
export interface Package {
  ...
  maintainer: string
  /**
   * The URL of the platforms index file (e.g.,
  ...
  fromJSON(object: any): BoardDetailsResponse {
    return {
      ...
      propertiesId: isSet(object.propertiesId)
        ? globalThis.String(object.propertiesId)
        : '',
      alias: isSet(object.alias) ? globalThis.String(object.alias) : '',
      official: isSet(object.official)
        ? globalThis.Boolean(object.official)
        : false,
      pinout: isSet(object.pinout) ? globalThis.String(object.pinout) : '',
      ...
      platform: isSet(object.platform)
        ...
        : undefined,
      toolsDependencies: globalThis.Array.isArray(object?.toolsDependencies)
        ? object.toolsDependencies.map((e: any) =>
            ToolsDependencies.fromJSON(e)
          )
        : [],
      configOptions: globalThis.Array.isArray(object?.configOptions)
        ? object.configOptions.map((e: any) => ConfigOption.fromJSON(e))
        : [],
      programmers: globalThis.Array.isArray(object?.programmers)
        ? object.programmers.map((e: any) => Programmer.fromJSON(e))
        : [],
      identificationProperties: globalThis.Array.isArray(
      ...
      defaultProgrammerId: isSet(object.defaultProgrammerId)
        ? globalThis.String(object.defaultProgrammerId)
        : '',
    }
  },
...
export const BoardIdentificationProperties_PropertiesEntry = {
  ...
  create(
    ...
    return BoardIdentificationProperties_PropertiesEntry.fromPartial(base ?? {})
  },
  fromPartial(
...
export const ToolsDependencies = {
  ...
  fromJSON(object: any): ToolsDependencies {
    return {
      packager: isSet(object.packager)
        ? globalThis.String(object.packager)
        : '',
      name: isSet(object.name) ? globalThis.String(object.name) : '',
      version: isSet(object.version) ? globalThis.String(object.version) : '',
  ...
  fromJSON(object: any): ConfigOption {
    return {
      ...
      optionLabel: isSet(object.optionLabel)
        ? globalThis.String(object.optionLabel)
        : '',
  ...
  fromJSON(object: any): ConfigValue {
    return {
      ...
      valueLabel: isSet(object.valueLabel)
        ? globalThis.String(object.valueLabel)
        : '',
      selected: isSet(object.selected)
        ? globalThis.Boolean(object.selected)
        : false,
    }
  },
...
export const BoardListRequest = {
  encode(
    ...
    if (message.skipCloudApiForBoardDetection !== false) {
  ...
  fromJSON(object: any): BoardListRequest {
    return {
      ...
      fqbn: isSet(object.fqbn) ? globalThis.String(object.fqbn) : '',
      skipCloudApiForBoardDetection: isSet(object.skipCloudApiForBoardDetection)
        ? globalThis.Boolean(object.skipCloudApiForBoardDetection)
        : false,
    }
  },
  ...
  toJSON(message: BoardListRequest): unknown {
    ...
    if (message.skipCloudApiForBoardDetection !== false) {
      obj.skipCloudApiForBoardDetection = message.skipCloudApiForBoardDetection
    }
    return obj
  },
...
export const DetectedPort = {
  ...
  fromJSON(object: any): DetectedPort {
    return {
      matchingBoards: globalThis.Array.isArray(object?.matchingBoards)
...
export const BoardListAllRequest = {
  encode(
    ...
    if (message.includeHiddenBoards !== false) {
  ...
  fromJSON(object: any): BoardListAllRequest {
    return {
      instance: isSet(object.instance)
        ? Instance.fromJSON(object.instance)
        : undefined,
      searchArgs: globalThis.Array.isArray(object?.searchArgs)
        ? object.searchArgs.map((e: any) => globalThis.String(e))
        : [],
      includeHiddenBoards: isSet(object.includeHiddenBoards)
        ? globalThis.Boolean(object.includeHiddenBoards)
        : false,
    }
  },
...
export const BoardIdentifyRequest = {
  encode(
    ...
    if (message.useCloudApiForUnknownBoardDetection !== false) {
  ...
  fromJSON(object: any): BoardIdentifyRequest {
    return {
      ...
      useCloudApiForUnknownBoardDetection: isSet(
        ...
        ? globalThis.Boolean(object.useCloudApiForUnknownBoardDetection)
        : false,
    }
  },
  ...
  fromPartial(object: DeepPartial<BoardIdentifyRequest>): BoardIdentifyRequest {
    const message = createBaseBoardIdentifyRequest()
    message.instance =
      object.instance !== undefined && object.instance !== null
        ? Instance.fromPartial(object.instance)
