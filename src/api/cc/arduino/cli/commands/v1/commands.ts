...
export enum FailedInstanceInitReason {
   ...
   * FAILED_INSTANCE_INIT_REASON_UNSPECIFIED the error reason is not
   * specialized.
   */
  FAILED_INSTANCE_INIT_REASON_UNSPECIFIED = 0,
  /**
   * FAILED_INSTANCE_INIT_REASON_INVALID_INDEX_URL - INVALID_INDEX_URL a package
   * index url is malformed.
   */
...
export interface NewSketchRequest {
  ...
  sketchName: string
  /**
   * Optional: create a Sketch in this directory (used as "Sketchbook"
   * directory). Default Sketchbook directory "directories.User" is used if
   * sketch_dir is empty.
   */
  sketchDir: string
...
export interface CheckForArduinoCLIUpdatesResponse {
  /**
   * The latest version of Arduino CLI available, if bigger than the current
   * version.
   */
...
export const InitResponse = {
  ...
  toJSON(message: InitResponse): unknown {
    ...
    if (message.message?.$case === 'profile') {
      obj.profile = SketchProfile.toJSON(message.message.profile)
    }
    return obj
  },
...
export const UpdateIndexRequest = {
  encode(
    ...
    if (message.ignoreCustomPackageIndexes !== false) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.updateIfOlderThanSecs = longToNumber(reader.int64() as Long)
          continue
      }
      if ((tag & 7) === 4 || tag === 0) {
        break
  ...
  fromJSON(object: any): UpdateIndexRequest {
    return {
      ...
      ignoreCustomPackageIndexes: isSet(object.ignoreCustomPackageIndexes)
        ? globalThis.Boolean(object.ignoreCustomPackageIndexes)
        : false,
      updateIfOlderThanSecs: isSet(object.updateIfOlderThanSecs)
        ? globalThis.Number(object.updateIfOlderThanSecs)
        : 0,
    }
  },
  ...
  toJSON(message: UpdateIndexRequest): unknown {
    ...
    if (message.updateIfOlderThanSecs !== 0) {
      obj.updateIfOlderThanSecs = Math.round(message.updateIfOlderThanSecs)
    }
    return obj
  },
...
export const UpdateIndexResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.message = {
            $case: 'downloadProgress',
            downloadProgress: DownloadProgress.decode(reader, reader.uint32()),
          }
          continue
        case 2:
          if (tag !== 18) {
          ...
          message.message = {
            $case: 'result',
            result: UpdateIndexResponse_Result.decode(reader, reader.uint32()),
          }
          continue
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    return {
      message: isSet(object.downloadProgress)
        ...
        : isSet(object.result)
          ? {
              $case: 'result',
              result: UpdateIndexResponse_Result.fromJSON(object.result),
            }
          : undefined,
    }
  },
  ...
  toJSON(message: UpdateIndexResponse): unknown {
    const obj: any = {}
    if (message.message?.$case === 'downloadProgress') {
      obj.downloadProgress = DownloadProgress.toJSON(
        message.message.downloadProgress
      )
    }
    if (message.message?.$case === 'result') {
      obj.result = UpdateIndexResponse_Result.toJSON(message.message.result)
    }
    return obj
  },
  ...
  fromPartial(object: DeepPartial<UpdateIndexResponse>): UpdateIndexResponse {
    ...
    if (
      ...
      message.message = {
        $case: 'result',
        result: UpdateIndexResponse_Result.fromPartial(object.message.result),
      }
    }
    return message
  },
...
export const UpdateIndexResponse_Result = {
  ...
  fromJSON(object: any): UpdateIndexResponse_Result {
    return {
      updatedIndexes: globalThis.Array.isArray(object?.updatedIndexes)
        ? object.updatedIndexes.map((e: any) => IndexUpdateReport.fromJSON(e))
        : [],
    }
  },
  ...
  toJSON(message: UpdateIndexResponse_Result): unknown {
    const obj: any = {}
    if (message.updatedIndexes?.length) {
      obj.updatedIndexes = message.updatedIndexes.map((e) =>
        IndexUpdateReport.toJSON(e)
      )
    }
    return obj
  },
  ...
  fromPartial(
    ...
    message.updatedIndexes =
      object.updatedIndexes?.map((e) => IndexUpdateReport.fromPartial(e)) || []
    return message
  },
}
...
export const UpdateLibrariesIndexResponse = {
  ...
  toJSON(message: UpdateLibrariesIndexResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = UpdateLibrariesIndexResponse_Result.toJSON(
        message.message.result
      )
    }
    return obj
...
export const UpdateLibrariesIndexResponse_Result = {
  ...
  toJSON(message: UpdateLibrariesIndexResponse_Result): unknown {
    const obj: any = {}
    if (message.librariesIndex !== undefined) {
      obj.librariesIndex = IndexUpdateReport.toJSON(message.librariesIndex)
    }
    return obj
  },
  ...
  fromPartial(
    ...
    const message = createBaseUpdateLibrariesIndexResponse_Result()
    message.librariesIndex =
      object.librariesIndex !== undefined && object.librariesIndex !== null
  ...
  fromJSON(object: any): NewSketchRequest {
    return {
      sketchName: isSet(object.sketchName)
        ? globalThis.String(object.sketchName)
        : '',
      sketchDir: isSet(object.sketchDir)
        ? globalThis.String(object.sketchDir)
        : '',
...
export const NewSketchResponse = {
  ...
  fromJSON(object: any): NewSketchResponse {
    return {
      mainFile: isSet(object.mainFile)
        ? globalThis.String(object.mainFile)
        : '',
    }
  },
...
export const LoadSketchResponse = {
  ...
  fromJSON(object: any): LoadSketchResponse {
    return {
      sketch: isSet(object.sketch) ? Sketch.fromJSON(object.sketch) : undefined,
    }
  },
  ...
  toJSON(message: LoadSketchResponse): unknown {
    const obj: any = {}
    if (message.sketch !== undefined) {
      obj.sketch = Sketch.toJSON(message.sketch)
    }
    return obj
  },
...
export const ArchiveSketchRequest = {
  encode(
    ...
    if (message.includeBuildDir !== false) {
  ...
  fromJSON(object: any): ArchiveSketchRequest {
    return {
      ...
      includeBuildDir: isSet(object.includeBuildDir)
        ? globalThis.Boolean(object.includeBuildDir)
        : false,
      overwrite: isSet(object.overwrite)
        ? globalThis.Boolean(object.overwrite)
        : false,
  ...
  fromJSON(object: any): SetSketchDefaultsRequest {
    return {
      ...
      defaultFqbn: isSet(object.defaultFqbn)
        ? globalThis.String(object.defaultFqbn)
        : '',
      defaultPortAddress: isSet(object.defaultPortAddress)
        ? globalThis.String(object.defaultPortAddress)
        : '',
      defaultPortProtocol: isSet(object.defaultPortProtocol)
        ? globalThis.String(object.defaultPortProtocol)
        : '',
      defaultProgrammer: isSet(object.defaultProgrammer)
        ? globalThis.String(object.defaultProgrammer)
        : '',
    }
  },
  ...
  fromJSON(object: any): CheckForArduinoCLIUpdatesRequest {
    return {
      forceCheck: isSet(object.forceCheck)
        ? globalThis.Boolean(object.forceCheck)
        : false,
    }
  },
  ...
  fromJSON(object: any): CheckForArduinoCLIUpdatesResponse {
    return {
      newestVersion: isSet(object.newestVersion)
        ? globalThis.String(object.newestVersion)
        : '',
    }
  },
...
export const ArduinoCoreServiceDefinition = {
  ...
  methods: {
    ...
    /**
     * Sets the sketch default FQBN and Port Address/Protocol in the sketch
     * project file (sketch.yaml). These metadata can be retrieved using
     * LoadSketch.
     */
    setSketchDefaults: {
    ...
    /**
     * Uninstall a platform as well as its tool dependencies that are not used
     * by other installed platforms.
     */
    platformUninstall: {
    ...
    /**
     * Returns the list of users fields necessary to upload to that board using
