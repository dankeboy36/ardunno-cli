  ...
  fromJSON(object: any): DownloadProgressUpdate {
    return {
      downloaded: isSet(object.downloaded)
        ? globalThis.Number(object.downloaded)
        : 0,
...
export const Platform = {
  encode(
    ...
    if (message.release !== undefined) {
      PlatformRelease.encode(message.release, writer.uint32(18).fork()).ldelim()
    }
    return writer
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.metadata = PlatformMetadata.decode(reader, reader.uint32())
          continue
        case 2:
          if (tag !== 18) {
            break
          ...
          message.release = PlatformRelease.decode(reader, reader.uint32())
          continue
      }
      if ((tag & 7) === 4 || tag === 0) {
        break
  ...
  toJSON(message: Platform): unknown {
    const obj: any = {}
    if (message.metadata !== undefined) {
      obj.metadata = PlatformMetadata.toJSON(message.metadata)
    }
    if (message.release !== undefined) {
      obj.release = PlatformRelease.toJSON(message.release)
    }
    return obj
  },
...
export const PlatformSummary_ReleasesEntry = {
  encode(
    ...
    if (message.value !== undefined) {
      PlatformRelease.encode(message.value, writer.uint32(18).fork()).ldelim()
    }
    return writer
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.value = PlatformRelease.decode(reader, reader.uint32())
          continue
      }
      if ((tag & 7) === 4 || tag === 0) {
        break
  ...
  toJSON(message: PlatformSummary_ReleasesEntry): unknown {
    ...
    if (message.value !== undefined) {
      obj.value = PlatformRelease.toJSON(message.value)
    }
    return obj
  },
...
export const PlatformMetadata = {
  encode(
    ...
    if (message.manuallyInstalled !== false) {
  ...
  fromJSON(object: any): PlatformMetadata {
    return {
      ...
      manuallyInstalled: isSet(object.manuallyInstalled)
        ? globalThis.Boolean(object.manuallyInstalled)
        : false,
      deprecated: isSet(object.deprecated)
        ? globalThis.Boolean(object.deprecated)
        : false,
      indexed: isSet(object.indexed)
        ? globalThis.Boolean(object.indexed)
        : false,
    }
  },
...
export const PlatformRelease = {
  encode(
    ...
    if (message.help !== undefined) {
      HelpResources.encode(message.help, writer.uint32(50).fork()).ldelim()
    }
    if (message.missingMetadata !== false) {
  ...
  fromJSON(object: any): PlatformRelease {
    return {
      ...
      installed: isSet(object.installed)
        ? globalThis.Boolean(object.installed)
        : false,
      boards: globalThis.Array.isArray(object?.boards)
      ...
      missingMetadata: isSet(object.missingMetadata)
        ? globalThis.Boolean(object.missingMetadata)
        : false,
      deprecated: isSet(object.deprecated)
        ? globalThis.Boolean(object.deprecated)
        : false,
      compatible: isSet(object.compatible)
        ? globalThis.Boolean(object.compatible)
        : false,
    }
  },
  ...
  fromJSON(object: any): InstalledPlatformReference {
    return {
      ...
      packageUrl: isSet(object.packageUrl)
        ? globalThis.String(object.packageUrl)
        : '',
    }
  },
...
export const HelpResources = {
  ...
  fromJSON(object: any): HelpResources {
    return {
      online: isSet(object.online) ? globalThis.String(object.online) : '',
    }
  },
...
export const Sketch = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          message.defaultProfile = SketchProfile.decode(reader, reader.uint32())
          continue
        case 11:
          if (tag !== 90) {
            break
  ...
  fromJSON(object: any): Sketch {
    return {
      ...
      locationPath: isSet(object.locationPath)
        ? globalThis.String(object.locationPath)
        : '',
      otherSketchFiles: globalThis.Array.isArray(object?.otherSketchFiles)
        ? object.otherSketchFiles.map((e: any) => globalThis.String(e))
        : [],
      additionalFiles: globalThis.Array.isArray(object?.additionalFiles)
        ? object.additionalFiles.map((e: any) => globalThis.String(e))
        : [],
      rootFolderFiles: globalThis.Array.isArray(object?.rootFolderFiles)
        ? object.rootFolderFiles.map((e: any) => globalThis.String(e))
        : [],
      defaultFqbn: isSet(object.defaultFqbn)
        ? globalThis.String(object.defaultFqbn)
        : '',
      defaultPort: isSet(object.defaultPort)
        ? globalThis.String(object.defaultPort)
        : '',
  ...
  toJSON(message: Sketch): unknown {
    ...
    if (message.defaultPortConfig !== undefined) {
      obj.defaultPortConfig = MonitorPortConfiguration.toJSON(
        message.defaultPortConfig
      )
    }
    return obj
...
export const SketchProfile = {
  ...
  toJSON(message: SketchProfile): unknown {
    ...
    if (message.portConfig !== undefined) {
      obj.portConfig = MonitorPortConfiguration.toJSON(message.portConfig)
    }
    if (message.protocol !== '') {
