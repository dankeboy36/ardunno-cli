  ...
  fromJSON(object: any): PlatformInstallRequest {
    return {
      ...
      platformPackage: isSet(object.platformPackage)
        ? globalThis.String(object.platformPackage)
        : '',
...
export const PlatformInstallResponse = {
      ...
      message: isSet(object.progress)
        ...
        : isSet(object.taskProgress)
          ...
          : isSet(object.result)
            ? {
                $case: 'result',
                result: PlatformInstallResponse_Result.fromJSON(object.result),
              }
            : undefined,
    }
  },
  ...
  toJSON(message: PlatformInstallResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = PlatformInstallResponse_Result.toJSON(message.message.result)
    }
    return obj
  },
...
export const PlatformDownloadResponse = {
    ...
    return {
      message: isSet(object.progress)
        ...
        : isSet(object.result)
          ? {
              $case: 'result',
              result: PlatformDownloadResponse_Result.fromJSON(object.result),
            }
          : undefined,
    }
  },
  ...
  toJSON(message: PlatformDownloadResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = PlatformDownloadResponse_Result.toJSON(
        message.message.result
      )
    }
    return obj
...
export const PlatformUninstallResponse = {
    ...
    return {
      message: isSet(object.taskProgress)
        ...
        : isSet(object.result)
          ? {
              $case: 'result',
              result: PlatformUninstallResponse_Result.fromJSON(object.result),
            }
          : undefined,
    }
  },
  ...
  toJSON(message: PlatformUninstallResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = PlatformUninstallResponse_Result.toJSON(
        message.message.result
      )
    }
    return obj
...
export const PlatformUpgradeResponse = {
      ...
      message: isSet(object.progress)
        ...
        : isSet(object.taskProgress)
          ...
          : isSet(object.result)
            ? {
                $case: 'result',
                result: PlatformUpgradeResponse_Result.fromJSON(object.result),
              }
            : undefined,
    }
  },
  ...
  toJSON(message: PlatformUpgradeResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = PlatformUpgradeResponse_Result.toJSON(message.message.result)
    }
    return obj
  },
...
export const PlatformSearchResponse = {
  ...
  fromJSON(object: any): PlatformSearchResponse {
    return {
      searchOutput: globalThis.Array.isArray(object?.searchOutput)
        ? object.searchOutput.map((e: any) => PlatformSummary.fromJSON(e))
        : [],
    }
  },
