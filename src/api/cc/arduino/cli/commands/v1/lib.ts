...
export enum LibraryInstallLocation {
  /**
   * LIBRARY_INSTALL_LOCATION_USER - In the `libraries` subdirectory of the user
   * directory (sketchbook). This is the default if not specified.
   */
  LIBRARY_INSTALL_LOCATION_USER = 0,
  /**
   * LIBRARY_INSTALL_LOCATION_BUILTIN - In the configured 'builtin.libraries'
   * directory.
   */
...
export enum LibraryLocation {
  ...
  /**
   * LIBRARY_LOCATION_USER - In the `libraries` subdirectory of the user
   * directory (sketchbook).
   */
  LIBRARY_LOCATION_USER = 1,
  /**
   * LIBRARY_LOCATION_PLATFORM_BUILTIN - In the `libraries` subdirectory of a
   * platform.
   */
  LIBRARY_LOCATION_PLATFORM_BUILTIN = 2,
  /**
   * LIBRARY_LOCATION_REFERENCED_PLATFORM_BUILTIN - When `LibraryLocation` is
   * used in a context where a board is specified, this indicates the library is
   * in the `libraries` subdirectory of a platform referenced by the board's
   * platform.
   */
  LIBRARY_LOCATION_REFERENCED_PLATFORM_BUILTIN = 3,
  /**
   * LIBRARY_LOCATION_UNMANAGED - Outside the `libraries` folders managed by the
   * CLI.
   */
...
export interface LibraryResolveDependenciesRequest {
  ...
  version: string
  /**
   * If true the computed solution will try to keep exising libraries at their
   * current version.
   */
...
export interface LibraryRelease {
  ...
  /**
   * The names of the library's dependencies, as defined by the 'depends' field
...
export interface LibraryListRequest {
  ...
  instance: Instance | undefined
  /**
   * Whether to include built-in libraries (from platforms and the Arduino IDE)
   * in the listing.
   */
  all: boolean
  /**
   * Whether to list only libraries for which there is a newer version than the
   * installed version available in the libraries index.
   */
  updatable: boolean
  /** If set filters out the libraries not matching name. */
  name: string
  /**
   * By setting this field all duplicate libraries are filtered out leaving only
   * the libraries that will be used to compile for the specified board FQBN.
   */
  fqbn: string
}
...
export interface Library {
  ...
  architectures: string[]
  /**
   * The type categories of the library. Possible values: `Arduino`, `Partner`,
   * `Recommended`, `Contributed`, `Retired`.
   */
  types: string[]
   ...
   * identifying string for the platform containing the library (e.g.,
   * `arduino:avr@1.8.2`).
   */
...
export const LibraryDownloadResponse = {
    ...
    return {
      message: isSet(object.progress)
        ...
        : isSet(object.result)
          ? {
              $case: 'result',
              result: LibraryDownloadResponse_Result.fromJSON(object.result),
            }
          : undefined,
    }
  },
  ...
  toJSON(message: LibraryDownloadResponse): unknown {
    ...
    if (message.message?.$case === 'progress') {
      obj.progress = DownloadProgress.toJSON(message.message.progress)
    }
    if (message.message?.$case === 'result') {
      obj.result = LibraryDownloadResponse_Result.toJSON(message.message.result)
    }
    return obj
  },
...
export const LibraryInstallRequest = {
  encode(
    ...
    if (message.noDeps !== false) {
      writer.uint32(32).bool(message.noDeps)
    }
    if (message.noOverwrite !== false) {
  ...
  fromJSON(object: any): LibraryInstallRequest {
    return {
      ...
      name: isSet(object.name) ? globalThis.String(object.name) : '',
      version: isSet(object.version) ? globalThis.String(object.version) : '',
      noDeps: isSet(object.noDeps) ? globalThis.Boolean(object.noDeps) : false,
...
export const LibraryInstallResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.message = {
            $case: 'taskProgress',
            taskProgress: TaskProgress.decode(reader, reader.uint32()),
          }
          continue
        case 3:
          if (tag !== 26) {
      ...
      message: isSet(object.progress)
        ...
        : isSet(object.taskProgress)
          ...
          : isSet(object.result)
            ? {
                $case: 'result',
                result: LibraryInstallResponse_Result.fromJSON(object.result),
              }
            : undefined,
    }
  },
  ...
  toJSON(message: LibraryInstallResponse): unknown {
    ...
    if (message.message?.$case === 'taskProgress') {
      obj.taskProgress = TaskProgress.toJSON(message.message.taskProgress)
    }
    if (message.message?.$case === 'result') {
      obj.result = LibraryInstallResponse_Result.toJSON(message.message.result)
    }
    return obj
  },
  ...
  fromPartial(
    ...
    if (
      ...
      message.message = {
        $case: 'taskProgress',
        taskProgress: TaskProgress.fromPartial(object.message.taskProgress),
      }
    }
    if (
      object.message?.$case === 'result' &&
...
export const LibraryUpgradeResponse = {
      ...
      message: isSet(object.progress)
        ...
        : isSet(object.taskProgress)
          ...
          : isSet(object.result)
            ? {
                $case: 'result',
                result: LibraryUpgradeResponse_Result.fromJSON(object.result),
              }
            : undefined,
    }
  },
  ...
  toJSON(message: LibraryUpgradeResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = LibraryUpgradeResponse_Result.toJSON(message.message.result)
    }
    return obj
  },
...
export const LibraryUninstallResponse = {
    ...
    return {
      message: isSet(object.taskProgress)
        ...
        : isSet(object.result)
          ? {
              $case: 'result',
              result: LibraryUninstallResponse_Result.fromJSON(object.result),
            }
          : undefined,
    }
  },
  ...
  toJSON(message: LibraryUninstallResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = LibraryUninstallResponse_Result.toJSON(
        message.message.result
      )
    }
    return obj
...
export const LibraryUpgradeAllResponse = {
  ...
  toJSON(message: LibraryUpgradeAllResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = LibraryUpgradeAllResponse_Result.toJSON(
        message.message.result
      )
    }
    return obj
...
export const LibraryResolveDependenciesRequest = {
  encode(
    ...
    if (message.doNotUpdateInstalledLibraries !== false) {
  ...
  fromJSON(object: any): LibraryResolveDependenciesRequest {
    return {
      ...
      name: isSet(object.name) ? globalThis.String(object.name) : '',
      version: isSet(object.version) ? globalThis.String(object.version) : '',
      doNotUpdateInstalledLibraries: isSet(object.doNotUpdateInstalledLibraries)
        ? globalThis.Boolean(object.doNotUpdateInstalledLibraries)
        : false,
    }
  },
  ...
  toJSON(message: LibraryResolveDependenciesRequest): unknown {
    ...
    if (message.doNotUpdateInstalledLibraries !== false) {
      obj.doNotUpdateInstalledLibraries = message.doNotUpdateInstalledLibraries
    }
    return obj
  },
  ...
  fromJSON(object: any): LibraryDependencyStatus {
    return {
      ...
      versionRequired: isSet(object.versionRequired)
        ? globalThis.String(object.versionRequired)
        : '',
      versionInstalled: isSet(object.versionInstalled)
        ? globalThis.String(object.versionInstalled)
        : '',
    }
  },
...
export const LibrarySearchRequest = {
  encode(
    ...
    if (message.omitReleasesDetails !== false) {
  ...
  fromJSON(object: any): LibrarySearchRequest {
    return {
      ...
      omitReleasesDetails: isSet(object.omitReleasesDetails)
        ? globalThis.Boolean(object.omitReleasesDetails)
        : false,
      searchArgs: isSet(object.searchArgs)
        ? globalThis.String(object.searchArgs)
        : '',
    }
  },
  ...
  fromJSON(object: any): SearchedLibrary {
    return {
      ...
      availableVersions: globalThis.Array.isArray(object?.availableVersions)
        ? object.availableVersions.map((e: any) => globalThis.String(e))
        : [],
    }
  },
  ...
  fromJSON(object: any): LibraryRelease {
    return {
      ...
      maintainer: isSet(object.maintainer)
        ? globalThis.String(object.maintainer)
        : '',
      sentence: isSet(object.sentence)
        ? globalThis.String(object.sentence)
        : '',
      paragraph: isSet(object.paragraph)
        ? globalThis.String(object.paragraph)
        : '',
      website: isSet(object.website) ? globalThis.String(object.website) : '',
      category: isSet(object.category)
        ? globalThis.String(object.category)
        : '',
      architectures: globalThis.Array.isArray(object?.architectures)
        ? object.architectures.map((e: any) => globalThis.String(e))
        : [],
      ...
      providesIncludes: globalThis.Array.isArray(object?.providesIncludes)
        ? object.providesIncludes.map((e: any) => globalThis.String(e))
        : [],
      dependencies: globalThis.Array.isArray(object?.dependencies)
  ...
  fromJSON(object: any): DownloadResource {
    return {
      ...
      archiveFilename: isSet(object.archiveFilename)
        ? globalThis.String(object.archiveFilename)
        : '',
      checksum: isSet(object.checksum)
        ? globalThis.String(object.checksum)
        : '',
      size: isSet(object.size) ? globalThis.Number(object.size) : 0,
      cachePath: isSet(object.cachePath)
        ? globalThis.String(object.cachePath)
        : '',
    }
  },
  ...
  fromJSON(object: any): LibraryListRequest {
    return {
      ...
      updatable: isSet(object.updatable)
        ? globalThis.Boolean(object.updatable)
        : false,
      name: isSet(object.name) ? globalThis.String(object.name) : '',
...
export const LibraryListResponse = {
  ...
  fromJSON(object: any): LibraryListResponse {
    return {
      installedLibraries: globalThis.Array.isArray(object?.installedLibraries)
...
export const Library = {
  encode(
    ...
    if (message.dotALinkage !== false) {
      writer.uint32(136).bool(message.dotALinkage)
    }
    if (message.precompiled !== false) {
    ...
    if (message.inDevelopment !== false) {
  ...
  fromJSON(object: any): Library {
    return {
      ...
      installDir: isSet(object.installDir)
        ? globalThis.String(object.installDir)
        : '',
      sourceDir: isSet(object.sourceDir)
        ? globalThis.String(object.sourceDir)
        : '',
      utilityDir: isSet(object.utilityDir)
        ? globalThis.String(object.utilityDir)
        : '',
      containerPlatform: isSet(object.containerPlatform)
        ? globalThis.String(object.containerPlatform)
        : '',
      dotALinkage: isSet(object.dotALinkage)
        ? globalThis.Boolean(object.dotALinkage)
        : false,
      precompiled: isSet(object.precompiled)
        ? globalThis.Boolean(object.precompiled)
        : false,
      ldFlags: isSet(object.ldFlags) ? globalThis.String(object.ldFlags) : '',
      isLegacy: isSet(object.isLegacy)
        ? globalThis.Boolean(object.isLegacy)
        : false,
      version: isSet(object.version) ? globalThis.String(object.version) : '',
      license: isSet(object.license) ? globalThis.String(object.license) : '',
      ...
      inDevelopment: isSet(object.inDevelopment)
        ? globalThis.Boolean(object.inDevelopment)
        : false,
    }
  },
...
export const ZipLibraryInstallResponse = {
    ...
    return {
      message: isSet(object.taskProgress)
        ...
        : isSet(object.result)
          ? {
              $case: 'result',
              result: ZipLibraryInstallResponse_Result.fromJSON(object.result),
            }
          : undefined,
    }
  },
  ...
  toJSON(message: ZipLibraryInstallResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = ZipLibraryInstallResponse_Result.toJSON(
        message.message.result
      )
    }
    return obj
...
export const GitLibraryInstallResponse = {
    ...
    return {
      message: isSet(object.taskProgress)
        ...
        : isSet(object.result)
          ? {
              $case: 'result',
              result: GitLibraryInstallResponse_Result.fromJSON(object.result),
            }
          : undefined,
    }
  },
  ...
  toJSON(message: GitLibraryInstallResponse): unknown {
    ...
    if (message.message?.$case === 'result') {
      obj.result = GitLibraryInstallResponse_Result.toJSON(
        message.message.result
      )
    }
    return obj
