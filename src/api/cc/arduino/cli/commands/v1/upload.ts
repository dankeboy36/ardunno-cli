...
export interface UploadRequest {
   ...
   * or in any case fields that can be customized by the user at upload time and
   * cannot be known previously. For more info:
...
export interface SupportedUserFieldsRequest {
  ...
  fqbn: string
  /**
   * Protocol that will be used to upload, this information is necessary to pick
   * the right upload tool for the board specified with the FQBN.
   */
  protocol: string
}
...
export interface SupportedUserFieldsResponse {
  /**
   * User fields supported by board specified in SupportedUserFieldsRequest. If
   * board doesn't support any field it will be empty.
   */
...
export const UploadRequest = {
  ...
  fromJSON(object: any): UploadRequest {
    return {
      ...
      importFile: isSet(object.importFile)
        ? globalThis.String(object.importFile)
        : '',
      ...
      userFields: isObject(object.userFields)
        ...
        : {},
      uploadProperties: globalThis.Array.isArray(object?.uploadProperties)
        ? object.uploadProperties.map((e: any) => globalThis.String(e))
        : [],
    }
  },
  ...
  toJSON(message: UploadRequest): unknown {
    ...
    if (message.uploadProperties?.length) {
      obj.uploadProperties = message.uploadProperties
    }
    return obj
  },
...
export const SupportedUserFieldsResponse = {
  ...
  fromJSON(object: any): SupportedUserFieldsResponse {
    return {
      userFields: globalThis.Array.isArray(object?.userFields)
